...
})({"3anFu":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "b5b5022fcdfb65b2";
...
},{}],"zwBmz":[function(require,module,exports) {
...
function fetchFromBackend(url, callback) {
    (0, _axiosDefault.default).get(url).then(async function(response) {
        // handle success
        callback(response);
...
function GenreString(GenreId) {
    if (GenreArray) {
        let GenreList = "";
        let countList = 0;
        for (const Genre of GenreArray)if (GenreId.includes(Genre.id)) {
            if (GenreList.length > 0) GenreList = GenreList + ", " + Genre.name;
            else GenreList = Genre.name;
            countList += 1;
            if (countList === 3) return GenreList;
        }
        return GenreList;
    }
}
    ...
    const markup = array.map(({ id , poster_path , genre_ids , original_title , release_date  })=>{
        return `<article class="card" data-id="${id}">
                      ...
                      <p class="card__genres">
                        ${GenreString(genre_ids)} | <span class="card__year">${release_date.split("-")[0]}</span>
                      </p>
                    </article>`;
    }).join("");
...
function createModal(data) {
    ...
    const instance1 = _basiclightbox.create(`<div class="modal">
...
},{"axios":"jo6P5","basiclightbox":"h9e8q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}]},["3anFu","zwBmz"], "zwBmz", "parcelRequired7c6")

//# sourceMappingURL=index.cdfb65b2.js.map
